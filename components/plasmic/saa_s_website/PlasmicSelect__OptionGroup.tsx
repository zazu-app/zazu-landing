...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: GZD1CvB9eMGA/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Ax2_XK3-BHKM/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__tL5T6)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__nslG3)}
              />
            </React.Fragment>
          ),
          value: args.children
