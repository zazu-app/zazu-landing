...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: mVDQhSZnr0H4/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg___572V8)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__lAc7Q)}
              role={"img"}
            />
          ),
